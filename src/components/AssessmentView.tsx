...
// 3. SRQ-20 QUESTIONS (Self Reporting Questionnaire)
const SRQ20_QUESTIONS: Question[] = [
  {
    id: 1,
    text: "Apakah Anda sering menderita sakit kepala dalam 1 bulan terakhir?",
    options: [{ score: 0, text: "Tidak" }, { score: 1, text: "Ya" }]
  },
  {
    id: 2,
    text: "Apakah Anda tidak nafsu makan dalam 1 bulan terakhir?",
    options: [{ score: 0, text: "Tidak" }, { score: 1, text: "Ya" }]
  },
  {
    id: 3,
    text: "Apakah Anda sulit tidur dalam 1 bulan terakhir?",
    options: [{ score: 0, text: "Tidak" }, { score: 1, text: "Ya" }]
  },
  {
    id: 4,
    text: "Apakah Anda mudah merasa takut dalam 1 bulan terakhir?",
    options: [{ score: 0, text: "Tidak" }, { score: 1, text: "Ya" }]
  },
  {
    id: 5,
    text: "Apakah Anda merasa cemas, tegang, atau khawatir dalam 1 bulan terakhir?",
    options: [{ score: 0, text: "Tidak" }, { score: 1, text: "Ya" }]
  },
  {
    id: 6,
    text: "Apakah tangan Anda gemetar dalam 1 bulan terakhir?",
    options: [{ score: 0, text: "Tidak" }, { score: 1, text: "Ya" }]
  },
  {
    id: 7,
    text: "Apakah pencernaan Anda terganggu atau merasa tidak enak di perut?",
    options: [{ score: 0, text: "Tidak" }, { score: 1, text: "Ya" }]
  },
  {
    id: 8,
    text: "Apakah Anda sulit berpikir jernih dalam 1 bulan terakhir?",
    options: [{ score: 0, text: "Tidak" }, { score: 1, text: "Ya" }]
  },
  {
    id: 9,
    text: "Apakah Anda merasa tidak bahagia dalam 1 bulan terakhir?",
    options: [{ score: 0, text: "Tidak" }, { score: 1, text: "Ya" }]
  },
  {
    id: 10,
    text: "Apakah Anda menangis lebih sering dalam 1 bulan terakhir?",
    options: [{ score: 0, text: "Tidak" }, { score: 1, text: "Ya" }]
  },
  {
    id: 11,
    text: "Apakah Anda merasa kesulitan untuk menikmati aktivitas sehari-hari?",
    options: [{ score: 0, text: "Tidak" }, { score: 1, text: "Ya" }]
  },
  {
    id: 12,
    text: "Apakah Anda kesulitan untuk mengambil keputusan dalam 1 bulan terakhir?",
    options: [{ score: 0, text: "Tidak" }, { score: 1, text: "Ya" }]
  },
  {
    id: 13,
    text: "Apakah aktivitas pekerjaan atau belajar sehari-hari Anda menjadi terganggu?",
    options: [{ score: 0, text: "Tidak" }, { score: 1, text: "Ya" }]
  },
  {
    id: 14,
    text: "Apakah Anda tidak mampu melakukan hal-hal yang berharga dalam hidup?",
    options: [{ score: 0, text: "Tidak" }, { score: 1, text: "Ya" }]
  },
  {
    id: 15,
    text: "Apakah Anda kehilangan minat pada berbagai hal dalam hidup?",
    options: [{ score: 0, text: "Tidak" }, { score: 1, text: "Ya" }]
  },
  {
    id: 16,
    text: "Apakah Anda merasa tidak berharga dalam 1 bulan terakhir?",
    options: [{ score: 0, text: "Tidak" }, { score: 1, text: "Ya" }]
  },
  {
    id: 17,
    text: "Apakah Anda mempunyai pikiran untuk mengakhiri hidup dalam 1 bulan terakhir?",
    options: [{ score: 0, text: "Tidak" }, { score: 1, text: "Ya" }]
  },
  {
    id: 18,
    text: "Apakah Anda merasa lelah sepanjang waktu dalam 1 bulan terakhir?",
    options: [{ score: 0, text: "Tidak" }, { score: 1, text: "Ya" }]
  },
  {
    id: 19,
    text: "Apakah Anda mudah lelah dalam beraktivitas harian?",
    options: [{ score: 0, text: "Tidak" }, { score: 1, text: "Ya" }]
  },
  {
    id: 20,
    text: "Apakah Anda merasa tidak enak di dada atau jantung berdebar-debar?",
    options: [{ score: 0, text: "Tidak" }, { score: 1, text: "Ya" }]
  }
];
